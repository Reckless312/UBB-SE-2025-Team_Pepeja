...
namespace App1.Database
{
    ...
    {
        private readonly string _connectionString = "Data Source=Raul\\SQLEXPRESS01;Initial Catalog=Community;Integrated Security=True;TrustServerCertificate=True;";
